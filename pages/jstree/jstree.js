define(['jstree'], function() {
	...
	var arrayData=[{text:'文件目录名称'},{text:'唯一标识'},{text:'文件目录状态，有多个参数选择:<br>selected<br>opened<br>disabled<br>checked<br>undetermined'},
				   {text:'自定义文件夹图标'},{text:'附加到节点的元数据，与显示无关'},{text:'节点类型'},{text:'添加到节点li的属性'},{text:'添加到a上的属性'}];
		...
		'core' : {
			'data' : [{
				...
				"children" : [
					...
					{ "text" : "custom icon URL", "icon" : "fa fa-leaf pl-s" },
					{ "text" : "initially open", "state" : { "opened" : true }, "children" : [ "Another node" ] },
					{ "text" : "custom icon class", "icon" : "fa fa-briefcase pl-e" }
				]
			},

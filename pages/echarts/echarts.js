define(['echarts', 'echartsMapChina'], function(echarts) {
	return {
		init: function() {
			var e = echarts.init(document.getElementById("echarts-line-chart"), 'light'),
				a = {
					title: {
						text: "未来一周气温变化"
					},
			...
			var t = echarts.init(document.getElementById("echarts-bar-chart"), 'light'),
				n = {
					title: {
						text: "某地区蒸发量和降水量"
					},
			...
			var r = echarts.init(document.getElementById("echarts-scatter-chart"), 'light'),
				o = {
					title: {
						text: "男性女性身高体重分布",
			...
			var i = echarts.init(document.getElementById("echarts-k-chart"), 'light'),
				m = {
					title: {
						text: "2013年上半年上证指数"
					},
			...
			var l = echarts.init(document.getElementById("echarts-pie-chart"), 'light'),
				u = {
					title: {
						text: "某站点用户访问来源",
						subtext: "纯属虚构",
			...
			var d = echarts.init(document.getElementById("echarts-radar-chart"), 'light'),
				h = {
					title: {
						text: "预算 vs 开销",
						subtext: "纯属虚构"
			...
			var s = echarts.init(document.getElementById("echarts-map-chart"), 'light'),
				c = {
					title: {
						text: "HUAWEI Mate销量",
						subtext: "纯属虚构",
					...
					legend: {
						orient: "vertical",
						x: "left",
						data: ["HUAWEI Mate20", "HUAWEI Mate20 X", "HUAWEI Mate20 Pro"]
					},
					dataRange: {
						min: 0,
						max: 2500,
			...
			var g = echarts.init(document.getElementById("echarts-funnel-chart")),
				v = {
					title: {
						text: '漏斗图',
						subtext: '纯属虚构'
			...
			setInterval(function() {
				x.series[0].data[0].value = (Math.random() * 100).toFixed(2) - 0;
				x.series[1].data[0].value = (Math.random() * 7).toFixed(2) - 0;
				x.series[2].data[0].value = (Math.random() * 2).toFixed(2) - 0;
				x.series[3].data[0].value = (Math.random() * 2).toFixed(2) - 0;
				M.setOption(x, true);
			}, 2000);
